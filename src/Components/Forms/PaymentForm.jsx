    ...
    return (
        ...
        <div>
            <form className="p-8" onSubmit={handleSubmit}>
                ...
                <button className="btn bg-[#ff946b] mt-10" type="submit" disabled={!stripe || !clientSecret}>
                    Donate
                </button>
                <div className="flex justify-end">
                    <button onClick={() => setShowModal(false)} className="btn bg-blue-500">Cancel</button>
                </div>
