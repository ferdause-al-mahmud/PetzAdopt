        ...
        <section className="py-24">
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-12 md:px-20">
                <div className="relative mb-6">
                    ...
                    <div className="absolute top-0 right-0 bg-black hover:bg-[#ff946b] hover:bg-opacity-60 bg-opacity-60 h-full hover:delay-100 hover:transition-all">
                        <div className="flex flex-col text-white hover:text-black justify-center items-center h-full">
                            <h3 className="text-2xl font-bold mb-4">Make a Difference with Your Donation</h3>
                            <div>
                                <p className="text-lg w-[70%] mx-auto mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    <div className="flex flex-1 flex-col md:relative items-center gap-4 mb-12">
                        ...
                        <div className="bg-black hover:bg-[#ff946b] hover:bg-opacity-60 bg-opacity-60 h-full hover:delay-100 hover:transition-all md:absolute">
                            <div className="flex flex-col text-white hover:text-black  justify-center items-center h-full">
                                <h3 className="text-2xl font-bold mb-4">Join Us in Saving Lives</h3>
                    ...
                    <div className="flex flex-1 flex-col md:relative items-center gap-4 mb-12">
                        ...
                        <div className="bg-black hover:bg-[#ff946b] hover:bg-opacity-60 bg-opacity-60 h-full hover:delay-100 hover:transition-all md:absolute">
                            <div className="flex flex-col text-white hover:text-black  justify-center items-center h-full">
                                <h3 className="text-2xl font-bold mb-4">Discover Unconditional Love</h3>
                                <p className="text-md px-4 mb-4">
                    ...
                    {/* <div className="flex flex-col md:flex-row-reverse items-center gap-4 mb-12">
                        <div className="order-2 md:w-1/2 md:pr-12">
                            <h3 className="text-2xl font-bold mb-4">Discover Unconditional Love</h3>
                        ...
                        <div className="order-1 md:w-1/2">
                            <img src="https://chicagoparent.nyc3.cdn.digitaloceanspaces.com/wp-content/uploads/2022/09/chicagoland-animal-shelters-photo-credit-the-anti-cruelty-society.jpg" alt="Image 2" className="w-full h-auto rounded-md shadow-md" />
                        </div>
                    </div> */}
                </div>
            </div>
